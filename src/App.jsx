...
function App() {
  ...
  useEffect(() => {
    ...
    const storedValues = JSON.parse(localStorage.getItem('mortgageCalculatorValues')) || {};
    ...
    if (urlParams.has('downPaymentPercentage')) {
      initialValues.downPaymentPercentage = Number(urlParams.get('downPaymentPercentage'));
    ...
    if (urlParams.has('closingCostPercentage')) {
      initialValues.closingCostPercentage = Number(urlParams.get('closingCostPercentage'));
    ...
    if (urlParams.has('buyerAgentCommissionPercentage')) {
      initialValues.buyerAgentCommissionPercentage = Number(urlParams.get('buyerAgentCommissionPercentage'));
    } else if (storedValues.buyerAgentCommissionPercentage !== undefined) {
      initialValues.buyerAgentCommissionPercentage = storedValues.buyerAgentCommissionPercentage;
    }
    
    if (urlParams.has('sellerAgentCommissionPercentage')) {
      initialValues.sellerAgentCommissionPercentage = Number(urlParams.get('sellerAgentCommissionPercentage'));
    } else if (storedValues.sellerAgentCommissionPercentage !== undefined) {
      initialValues.sellerAgentCommissionPercentage = storedValues.sellerAgentCommissionPercentage;
    }
  ...
  useEffect(() => {
    ...
    localStorage.setItem('mortgageCalculatorValues', JSON.stringify(formValues));
    ...
    if (formValues.mortgageAmount) {
      ...
      if (formValues.downPaymentPercentage !== DEFAULT_VALUES.downPaymentPercentage) {
        params.set('downPaymentPercentage', formValues.downPaymentPercentage);
      }
      
      if (formValues.closingCostPercentage !== DEFAULT_VALUES.closingCostPercentage) {
        params.set('closingCostPercentage', formValues.closingCostPercentage);
      }
      
      if (formValues.buyerAgentCommissionPercentage !== DEFAULT_VALUES.buyerAgentCommissionPercentage) {
        params.set('buyerAgentCommissionPercentage', formValues.buyerAgentCommissionPercentage);
      }
      
      if (formValues.sellerAgentCommissionPercentage !== DEFAULT_VALUES.sellerAgentCommissionPercentage) {
        params.set('sellerAgentCommissionPercentage', formValues.sellerAgentCommissionPercentage);
      }
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6 md:p-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Mortgage Calculator</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div>
                <Label htmlFor="buyerAgentCommissionPercentage" className="block mb-2">
              ...
              <div>
                <Label htmlFor="sellerAgentCommissionPercentage" className="block mb-2">
