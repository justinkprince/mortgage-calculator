...
export function calculateValues(mortgageAmount, downPaymentPercentage, closingCostPercentage, buyerAgentCommissionPercentage, sellerAgentCommissionPercentage) {
  ...
  for (let i = 0; i <= 10; i++) {
    ...
    const buyerAgentCommission = currentAmount * (buyerAgentCommissionPercentage / 100)
    const sellerAgentCommission = currentAmount * (sellerAgentCommissionPercentage / 100)
    const total = downPayment + closingCost + buyerAgentCommission + sellerAgentCommission
